...
function Appbar({showBackButton=false, title, subtitle, showActionsButtons=false}) {
  return (
    <div className={Style.appbar}>
      ...
      {showActionsButtons && <div className={Style.appbarActions}>
        <Navbar direction={Constants.HORIZONTAL} type={NavType.BUTTON} buttonType={ButtonType.DARK} links={[
          {to:"/home",element:<p>New</p>,  headIcon: <Icon size={IconSizes.sm} icon={Icons.ADD}></Icon>}]}>
        </Navbar>
      </div>}
    </div>
  )
